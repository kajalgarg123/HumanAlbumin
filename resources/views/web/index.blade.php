...
<div data-spy="scroll" data-target="#navbar">
   ...
   <div id="home" class="slider-area">
    ...
    <!-- End About area -->
	<div id="clinical" class="our-skill-area fix">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="doctr-text">
                        <!-- single-skill start -->
						<div class="col-md-12 col-sm-12 col-xs-12">
							 <h2>Lorem Ipsum is simply dummy <br> text of the printing and<br>typesetting industry. <br></h2>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="section-headline">
                        <h2>Our Local distributor and teams</h2>
                    </div>
                </div>
            </div>
            <div class="row">
