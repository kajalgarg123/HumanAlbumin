			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-8">
					<ul class="contact-details">
						<li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i>+800 2336 7811</a></li>
						<li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>human@albumin.com</a></li>
					</ul>	
				</div>
                        ...
                        <nav class="navbar navbar-default">
                          ...
                          <div class="collapse navbar-collapse main-menu bs-main-navbar-collapse-1" id="navbar-main">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li>
                                        <a class="page-scroll" href="about-us.html">About Albumin</a>
                                    </li>
                                    <li>
                                        <a class="page-scroll" href="clinical.html">Clinical Use</a>
                                    </li>
                                    <li>
                                        <a class="page-scroll" href="counterfeit.html">Counterfeit</a>
                                    </li>  
									<li class="button-product">
                                        <a href="spc-language.html">Summary of Product Characteristics</a> 
                                    </li>
								</ul>
                            </div>
                            <!-- navbar-collapse -->
			...
			<div class="row">
				<div class="col-md-12">
					<div class="clinical-text">
						...
						<a class="prdct-btn" href="#">Try Human Albumin</a>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="about" class="about area-padding">
        <div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-sm-12 col-xs-12">
					<div class="section-headline">
						...
						velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat  cillum dolore eu fugiat nulla pariatur. cillum dolore eu fugiat nulla pariatur. </p>
						<a class="read-btn" href="#">Read More</a>
					</div>
				</div>
			</div>
			<div class="product-specification">
				<h2 class="sec-head">Magnetic Resonance Imaging</h2>
			...
			<div class="section-headline">
				<h2>Magnetic Resonance Imaging</h2>
				<ul>
					<li><i class="fa fa-circle" aria-hidden="true"></i>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </li>
					<li><i class="fa fa-circle" aria-hidden="true"></i>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </li>
					<li><i class="fa fa-circle" aria-hidden="true"></i>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </li>
					<li><i class="fa fa-circle" aria-hidden="true"></i>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </li>
					<li><i class="fa fa-circle" aria-hidden="true"></i>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </li>
							...
							<div class="footer-content">
								<div class="footer-head">
									...
									<ul>
										...
										<li><a href="team.html">Team Advisor</a></li>
