                        ...
                        <nav class="navbar navbar-default">
                           ...
                           <div class="collapse navbar-collapse main-menu bs-main-navbar-collapse-1" id="navbar-main">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li>
                                        <a class="page-scroll" href="{{url('/about-us')}}">About Albumin</a>
                                    </li>
                                    <li>
                                        <a class="page-scroll" href="{{url('/clinical')}}">Clinical Use</a>
                                    </li>
                                    <li>
                                        <a class="page-scroll" href="{{url('/counterfeit')}}">Counterfeit</a>
                                    </li>  
									<li class="button-product">
                                        <a href="{{url('/spc-language')}}">Summary of Product Characteristics</a> 
                                    </li>
								</ul>
                            </div>
                            <!-- navbar-collapse -->
